...
mixin _$ClientProfile {
 ...
 String get id;@JsonKey(name: 'full_name') String? get fullName;@JsonKey(name: 'phone') String? get phoneNumber;@JsonKey(name: 'avatar_url') String? get avatarUrl; String get role;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,fullName,phoneNumber,avatarUrl,role);

@override
String toString() {
  return 'ClientProfile(id: $id, fullName: $fullName, phoneNumber: $phoneNumber, avatarUrl: $avatarUrl, role: $role)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'full_name') String? fullName,@JsonKey(name: 'phone') String? phoneNumber,@JsonKey(name: 'avatar_url') String? avatarUrl, String role
});
...
/// Create a copy of ClientProfile
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fullName = freezed,Object? phoneNumber = freezed,Object? avatarUrl = freezed,Object? role = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'phone')  String? phoneNumber, @JsonKey(name: 'avatar_url')  String? avatarUrl,  String role)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClientProfile() when $default != null:
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.avatarUrl,_that.role);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'phone')  String? phoneNumber, @JsonKey(name: 'avatar_url')  String? avatarUrl,  String role)  $default,) {final _that = this;
switch (_that) {
case _ClientProfile():
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.avatarUrl,_that.role);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'full_name')  String? fullName, @JsonKey(name: 'phone')  String? phoneNumber, @JsonKey(name: 'avatar_url')  String? avatarUrl,  String role)?  $default,) {final _that = this;
switch (_that) {
case _ClientProfile() when $default != null:
return $default(_that.id,_that.fullName,_that.phoneNumber,_that.avatarUrl,_that.role);case _:
  return null;
...
class _ClientProfile implements ClientProfile {
  const _ClientProfile({required this.id, @JsonKey(name: 'full_name') this.fullName, @JsonKey(name: 'phone') this.phoneNumber, @JsonKey(name: 'avatar_url') this.avatarUrl, this.role = 'client'});
...
/// Create a copy of ClientProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? fullName = freezed,Object? phoneNumber = freezed,Object? avatarUrl = freezed,Object? role = null,}) {
