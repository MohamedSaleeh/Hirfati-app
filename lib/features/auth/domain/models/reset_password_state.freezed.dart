...
mixin _$ResetPasswordState {
 ...
 bool get isLoading; bool get emailSent; String? get email; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,isLoading,emailSent,email,errorMessage);

@override
String toString() {
  return 'ResetPasswordState(isLoading: $isLoading, emailSent: $emailSent, email: $email, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 bool isLoading, bool emailSent, String? email, String? errorMessage
});
...
/// Create a copy of ResetPasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isLoading = null,Object? emailSent = null,Object? email = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  bool emailSent,  String? email,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResetPasswordState() when $default != null:
return $default(_that.isLoading,_that.emailSent,_that.email,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  bool emailSent,  String? email,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordState():
return $default(_that.isLoading,_that.emailSent,_that.email,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  bool emailSent,  String? email,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _ResetPasswordState() when $default != null:
return $default(_that.isLoading,_that.emailSent,_that.email,_that.errorMessage);case _:
  return null;
...
class _ResetPasswordState implements ResetPasswordState {
  const _ResetPasswordState({this.isLoading = false, this.emailSent = false, this.email, this.errorMessage});
...
/// Create a copy of ResetPasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isLoading = null,Object? emailSent = null,Object? email = freezed,Object? errorMessage = freezed,}) {
