...
mixin _$ReviewModel {
 ...
 String get id; String get orderId; String get clientId; String get workerId; int get rating; String? get comment; DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,orderId,clientId,workerId,rating,comment,createdAt);

@override
String toString() {
  return 'ReviewModel(id: $id, orderId: $orderId, clientId: $clientId, workerId: $workerId, rating: $rating, comment: $comment, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String orderId, String clientId, String workerId, int rating, String? comment, DateTime? createdAt
});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? orderId = null,Object? clientId = null,Object? workerId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String orderId,  String clientId,  String workerId,  int rating,  String? comment,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.orderId,_that.clientId,_that.workerId,_that.rating,_that.comment,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String orderId,  String clientId,  String workerId,  int rating,  String? comment,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _ReviewModel():
return $default(_that.id,_that.orderId,_that.clientId,_that.workerId,_that.rating,_that.comment,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String orderId,  String clientId,  String workerId,  int rating,  String? comment,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.orderId,_that.clientId,_that.workerId,_that.rating,_that.comment,_that.createdAt);case _:
  return null;
...
class _ReviewModel implements ReviewModel {
  const _ReviewModel({required this.id, required this.orderId, required this.clientId, required this.workerId, required this.rating, this.comment, this.createdAt});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? orderId = null,Object? clientId = null,Object? workerId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = freezed,}) {
